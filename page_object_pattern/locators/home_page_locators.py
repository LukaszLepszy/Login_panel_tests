...
class HomePageLocators:
    ...
    remember_me_checkbox = "input[type='checkbox'][id='user[remember_me]']"
    sign_in_button = "input[class='button button-primary g-recaptcha']"
    forgot_password_button = "a[class='form__forgot-password']"
    create_new_account = "a[href='/users/sign_up']"
    linkedin_button = "a[class='button linkedin']"
    ...
    first_name_input = "input[id='user[first_name]']"
    ...
    home_page = "https://courses.ultimateqa.com/collections"
    account_page = "https://courses.ultimateqa.com/account"
    account_password_page = "https://courses.ultimateqa.com/account/password"
